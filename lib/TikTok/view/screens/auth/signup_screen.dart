...
class SignUpScreen extends StatelessWidget {
  ...
  AuthController authUploadController = Get.put(AuthController());
        ...
        child: Container(
          ...
          child : Column(
            ...
            children: [
                ...
                child: Stack(
                  children: [
                    Obx(() {
                      return CircleAvatar(
                        radius: 60,
                        backgroundImage: AuthController.instance.proimg.value != null
                            ? FileImage(AuthController.instance.proimg.value!)
                            : const NetworkImage(
             ...
             AuthController.instance.SignUp(_usernameController.text, _emailController.text,_setpasswordController.text, AuthController.instance.proimg.value);
              }, child: Container(
